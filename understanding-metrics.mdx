...
The Campaign Metrics API exposes three layers of campaign performance. Pick the endpoint that matches how you plan to store and report the data.

Self-serve soundlink metrics are separate — see [Soundlinks](/soundlinks).
...
[Playlist position](/playlist-position) · [Campaign JSONL exports](/jsonl-exports) · [API Reference](/api-reference)
