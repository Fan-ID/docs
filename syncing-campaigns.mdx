...
Both list and detail rows include `dashboardUrl` — a logged-in insights URL (`/orgs/{organizationId}/insights/{smartLinkId}`). It uses the smart link id, not the campaign id.
