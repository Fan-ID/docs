...
Both list and detail rows include `apiManageable` — `true` only for wallet-funded campaigns, which are the ones you can [manage via the API](/managing-campaigns) (budget changes, tier updates, stop).
