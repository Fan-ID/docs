...
Requires the `metrics:read` scope. See [Campaign JSONL exports](/jsonl-exports) for streaming and date windows.
...
[Campaign metrics](/understanding-metrics) · [Campaign JSONL exports](/jsonl-exports) · [API Reference](/api-reference)
