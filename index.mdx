...
- **For Developers** — everything to build on the Public API: [Quickstart](/quickstart), [Authentication](/authentication), [Errors](/errors), [SDK overview](/sdks), and API guides for [campaigns](/syncing-campaigns) (sync, create, manage, [metrics](/understanding-metrics), [JSONL](/jsonl-exports)), [soundlinks](/soundlinks), and [video imports](/importing-videos).
