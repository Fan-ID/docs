...
- **For Developers** — everything to build on the Public API: [Quickstart](/quickstart), [Authentication](/authentication), [Errors](/errors), [SDK overview](/sdks), and API guides for [syncing](/syncing-campaigns), [creating](/creating-campaigns), and [managing](/managing-campaigns) campaigns, [video imports](/importing-videos), [metrics](/understanding-metrics), and [JSONL exports](/jsonl-exports).
