...
<Note>
  The video import rate limit (20/hour) is stricter than the general Public API rate limit, is
  counted separately per API key, and applies to how many import requests we accept — not how long
  ingestion takes.
</Note>
