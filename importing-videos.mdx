...
Provide a **public HTTPS URL to an MP4 file (max 70 MB)**. Soundlink downloads the file, stages it, and starts the background processing pipeline:
...
- Content must be **MP4**, up to **70 MB**
