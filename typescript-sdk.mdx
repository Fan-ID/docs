...
Full REST guides: [Syncing soundlinks](/soundlinks) · [Soundlink metrics](/soundlink-metrics). Scopes: [Authentication](/authentication).
...
[Syncing soundlinks](/soundlinks) → [Creating campaigns](/creating-campaigns) → [Managing campaigns](/managing-campaigns) → [Campaign metrics](/understanding-metrics)
