...
Soundlink breakdown and JSONL export methods are not in the SDK yet — use the HTTP paths in [Soundlink metrics](/soundlink-metrics) and [JSONL exports](/jsonl-exports).
...
| **Soundlinks** | `SoundlinkSummary`, `SoundlinkDetail`, `SoundlinkListData`, `SoundlinkMetricsOverview`, `SoundlinkEngagementItem` |
...
| **Params**     | `DateRangeParams`, `SoundlinkListParams`, `SoundlinkEngagementParams`, `BreakdownListParams`, `BreakdownExportParams`, `EngagementExportParams`, `IdempotencyOptions` |
