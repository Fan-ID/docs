...
Full REST guide: [Soundlinks](/soundlinks). Scopes: [Authentication](/authentication).
...
[Soundlinks](/soundlinks) → [Creating campaigns](/creating-campaigns) → [Managing campaigns](/managing-campaigns) → [Campaign metrics](/understanding-metrics)
