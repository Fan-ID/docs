...
Requires `soundlinks:read`. Self-serve soundlinks only (not campaign-linked).
...
| **Campaign metrics** | `MetricsOverview`, `BreakdownRow`, `BreakdownListData`, `EngagementRow`, `EngagementListData`                          |
| **Params**     | `DateRangeParams`, `SoundlinkListParams`, `SoundlinkBreakdownListParams`, `SoundlinkEngagementListParams`, `BreakdownListParams`, `BreakdownExportParams`, `EngagementListParams`, `EngagementExportParams`, `IdempotencyOptions` |
