...
Default Public API limits are **60 requests/minute** and **600 requests/hour**, keyed by API key or OAuth client. Video import is **5 imports/hour**, counted separately. Honor `Retry-After`.
