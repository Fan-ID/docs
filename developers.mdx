...
<CardGroup cols={2}>
  ...
  <Card title="Creating soundlinks" icon="plus" href="/creating-soundlinks">
...
<CardGroup cols={2}>
  <Card title="Importing videos" icon="film" href="/importing-videos">
    Import MP4 or QuickTime by URL and use `videoId`s in Full Control campaigns.
  </Card>
</CardGroup>
...
<AccordionGroup>
  ...
  <Accordion title="Timestamps and v1 scope">
    ...
    v1 covers campaign and metrics reads plus writes: [campaign create](/creating-campaigns), [budget changes, tier updates, and stop](/managing-campaigns), [soundlink create](/creating-soundlinks), [video imports](/importing-videos), and [soundlinks](/soundlinks).
