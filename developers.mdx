...
<AccordionGroup>
  ...
  <Accordion title="Authentication">
    ...
    The legacy `x-api-key: sk_<prefix>_<secret>` header still works but is deprecated and retires
    2026-08-17. See [Authentication](/authentication) for scopes and security.
