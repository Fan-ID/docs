...
| `soundlinks:write` | Create self-serve soundlinks                                           | When enabled for your organization |
...
Add `soundlinks:write` to [create soundlinks](/creating-soundlinks).
...
<Note>
  ...
  `soundlinks:write`. `soundlinks:write` appears in Settings when your organization is enabled
  for soundlink create.
</Note>
