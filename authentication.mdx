...
| ----------------- | ---------------------------------------------------- | ------------- |
| `campaigns:read`  | List campaigns, campaign detail                      | Yes           |
| `metrics:read`    | Metrics overview, breakdown, exports                 | Yes           |
| `campaigns:write` | Reserved for v2 (not available to customer keys yet) | No            |

Typical integrations enable **both** `campaigns:read` and `metrics:read`.
